...
void DlgPrefOsc::slotUpdate() {
    ...
    OscPortOut->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscPortOut"), 9001));
//    OscOutputBufferSize->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscOutputBufferSize"), 1024));
//    OscIpMtuSize->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscIpMtuSize"), 1536));

    OscReceiver1ActiveCheckBox->setChecked(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1Active"), false));
    QString OscReceiver1IpTest = m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1Ip"));

    OscReceiver1IpByte1->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1IpByte1"), 1));
    OscReceiver1IpByte2->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1IpByte2"), 1));
    OscReceiver1IpByte3->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1IpByte3"), 1));
    OscReceiver1IpByte4->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver1IpByte4"), 1));

    OscReceiver2ActiveCheckBox->setChecked(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver2Active"), false));
    OscReceiver2IpByte1->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver2IpByte1"), 1));
    OscReceiver2IpByte2->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver2IpByte2"), 1));
    OscReceiver2IpByte3->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver2IpByte3"), 1));
    OscReceiver2IpByte4->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver2IpByte4"), 1));

    OscReceiver3ActiveCheckBox->setChecked(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver3Active"), false));
    OscReceiver3IpByte1->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver3IpByte1"), 1));
    OscReceiver3IpByte2->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver3IpByte2"), 1));
    OscReceiver3IpByte3->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver3IpByte3"), 1));
    OscReceiver3IpByte4->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver3IpByte4"), 1));

    OscReceiver4ActiveCheckBox->setChecked(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver4Active"), false));
    OscReceiver4IpByte1->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver4IpByte1"), 1));
    OscReceiver4IpByte2->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver4IpByte2"), 1));
    OscReceiver4IpByte3->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver4IpByte3"), 1));
    OscReceiver4IpByte4->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver4IpByte4"), 1));

    OscReceiver5ActiveCheckBox->setChecked(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver5Active"), false));
    OscReceiver5IpByte1->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver5IpByte1"), 1));
    OscReceiver5IpByte2->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver5IpByte2"), 1));
    OscReceiver5IpByte3->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver5IpByte3"), 1));
    OscReceiver5IpByte4->setValue(m_pConfig->getValue(ConfigKey("[OSC]", "OscReceiver5IpByte4"), 1));
...
//            OscIpMtuSize->value());
    ...
    QString OscReceiverIp, OscReceiverIpByte1, OscReceiverIpByte2, OscReceiverIpByte3, OscReceiverIpByte4;
    ...
    OscReceiverIp = QString("%1.%2.%3.%4").arg(OscReceiverIpByte1)
    ...
    OscReceiverIp = QString("%1.%2.%3.%4").arg(OscReceiverIpByte1).arg(OscReceiverIpByte2).arg(OscReceiverIpByte3).arg(OscReceiverIpByte4);

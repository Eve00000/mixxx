...
//     if (e->type() == QEvent::MouseButtonPress && e->button() ==
//     Qt::RightButton) {
//         emit rightClicked();
//         return;
//     }
...
//     m_pEditLabel->setObjectName("CueLabelEdit");
//     m_pEditLabel->setPlaceholderText(tr("Label..."));
//     connect(m_pEditLabel.get(), &QLineEdit::textEdited, this,
//     &WCueMenuPopup::slotEditLabel); connect(m_pEditLabel.get(),
//     &QLineEdit::returnPressed, this, &WCueMenuPopup::hide);
//
//     // Eve
//     m_pEditStem1vol = std::make_unique<QLineEdit>(this);
//     m_pEditStem1vol->setToolTip(tr("Edit cue Volume for Stem 1 (- for mute;
//     0-100 volume)")); m_pEditStem1vol->setObjectName("CueStem1volEdit");
//     m_pEditStem1vol->setPlaceholderText(tr("Volume for Stem 1..."));
//     m_pEditStem1vol->setMaxLength(10);
//     m_pEditStem1vol->setMaximumSize(50, 20);
//     connect(m_pEditStem1vol.get(), &QLineEdit::textEdited, this,
//     &WCueMenuPopup::slotEditStem1vol); connect(m_pEditStem1vol.get(),
//     &QLineEdit::returnPressed, this, &WCueMenuPopup::hide);
//
//     m_pEditStem2vol = std::make_unique<QLineEdit>(this);
//     m_pEditStem2vol->setToolTip(tr("Edit cue Volume for Stem 2 (- for mute;
//     0-100 volume)")); m_pEditStem2vol->setObjectName("CueStem2volEdit");
//     m_pEditStem2vol->setPlaceholderText(tr("Volume for Stem 2..."));
//     m_pEditStem2vol->setMaxLength(10);
//     m_pEditStem2vol->setMaximumSize(50, 20);
//     connect(m_pEditStem2vol.get(), &QLineEdit::textEdited, this,
//     &WCueMenuPopup::slotEditStem2vol); connect(m_pEditStem2vol.get(),
//     &QLineEdit::returnPressed, this, &WCueMenuPopup::hide);
//
//     m_pEditStem3vol = std::make_unique<QLineEdit>(this);
//     m_pEditStem3vol->setToolTip(tr("Edit cue Volume for Stem 3 (- for mute;
//     0-100 volume)")); m_pEditStem3vol->setObjectName("CueStem3volEdit");
//     m_pEditStem3vol->setPlaceholderText(tr("Volume for Stem 3..."));
//     m_pEditStem3vol->setMaxLength(10);
//     m_pEditStem3vol->setMaximumSize(50, 20);
//     connect(m_pEditStem3vol.get(), &QLineEdit::textEdited, this,
//     &WCueMenuPopup::slotEditStem3vol); connect(m_pEditStem3vol.get(),
//     &QLineEdit::returnPressed, this, &WCueMenuPopup::hide);
//
//     m_pEditStem4vol = std::make_unique<QLineEdit>(this);
//     m_pEditStem4vol->setToolTip(tr("Edit cue Volume for Stem 4 (- for mute;
//     0-100 volume)")); m_pEditStem4vol->setObjectName("CueStem4volEdit");
//     m_pEditStem4vol->setPlaceholderText(tr("Volume for Stem 4..."));
//     m_pEditStem4vol->setMaxLength(10);
//     m_pEditStem4vol->setMaximumSize(50, 20);
//     connect(m_pEditStem4vol.get(), &QLineEdit::textEdited, this,
//     &WCueMenuPopup::slotEditStem4vol); connect(m_pEditStem4vol.get(),
//     &QLineEdit::returnPressed, this, &WCueMenuPopup::hide);
//
//     // Eve
//
...
//     m_pDeleteCue->setToolTip(tr("Delete this cue"));
//     m_pDeleteCue->setObjectName("CueDeleteButton");
//     connect(m_pDeleteCue.get(), &QPushButton::clicked, this,
//     &WCueMenuPopup::slotDeleteCue);
//
...
//             "\n\n" +
//             tr("Left-click: Use the old size or the current beatloop size as
//             the loop size") +
//             "\n" +
//             tr("Right-click: Use the current play position as loop end if it
//             is after the cue"));
//     m_pSavedLoopCue->setObjectName("CueSavedLoopButton");
//     m_pSavedLoopCue->setCheckable(true);
//     connect(m_pSavedLoopCue.get(),
...
//         if (hotcueNumber != Cue::kNoHotCue) {
//             // Programmers count from 0, but DJs count from 1
//             hotcueNumberText = QString(tr("Hotcue
//             #%1")).arg(QString::number(hotcueNumber + 1));
//         }
//         m_pCueNumber->setText(hotcueNumberText);
//
//         QString positionText = "";
...
//             double startPositionSeconds = pos.startPosition.value() /
//             m_pTrack->getSampleRate(); positionText =
//             mixxx::Duration::formatTime(startPositionSeconds,
//             mixxx::Duration::Precision::CENTISECONDS); if
//             (pos.endPosition.isValid() && m_pCue->getType() !=
//             mixxx::CueType::HotCue) {
//                 double endPositionSeconds = pos.endPosition.value() /
//                 m_pTrack->getSampleRate(); positionText = QString("%1 -
//                 %2").arg(positionText,
...
//         m_pEditLabel->setText(m_pCue->getLabel());
//         // Eve
//         m_pEditStem1vol->setText(QString("%1").arg(round(m_pCue->getStem1vol()
//         * 100)));
//         m_pEditStem2vol->setText(QString("%1").arg(round(m_pCue->getStem2vol()
//         * 100)));
//         m_pEditStem3vol->setText(QString("%1").arg(round(m_pCue->getStem3vol()
//         * 100)));
//         m_pEditStem4vol->setText(QString("%1").arg(round(m_pCue->getStem4vol()
//         * 100)));
//         // Eve
//         m_pColorPicker->setSelectedColor(m_pCue->getColor());
//         m_pSavedLoopCue->setChecked(m_pCue->getType() ==
//         mixxx::CueType::Loop);
//     } else {
//         m_pTrack.reset();
//         m_pCue.reset();
...
//    if (m_pQuantizeEnabled.toBool() && pBeats) {
//        mixxx::audio::FramePos nextBeatPosition, prevBeatPosition;
//        pBeats->findPrevNextBeats(position, &prevBeatPosition,
//        &nextBeatPosition, false); position = (nextBeatPosition - position >
//        position - prevBeatPosition)
//                ? prevBeatPosition
//                : nextBeatPosition;
//    }
//    if (position <= m_pCue->getPosition()) {

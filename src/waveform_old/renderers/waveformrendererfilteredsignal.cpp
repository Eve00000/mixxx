...
void WaveformRendererFilteredSignal::draw(QPainter* painter,
    ...
    for (int x = 0; x < static_cast<int>(length); ++x) {
        ...
        //     waveform->getAudioVisualRatio(); qDebug() << "visualSampleRate"
        //     << waveform->getVisualSampleRate(); qDebug() <<
        //     "audioSamplesPerVisualPixel" <<
        //     waveform->getAudioSamplesPerVisualSample(); qDebug() <<
        //     "visualSamplePerPixel" << visualSamplePerPixel; qDebug() <<
        //     "xSampleWidth" << xSampleWidth; qDebug() << "xVisualSampleIndex"
        //     << xVisualSampleIndex; qDebug() << "maxSamplingRange" <<
        //     maxSamplingRange;; qDebug() << "Sampling pixel " << x << "over ["
    ...
    painter->setPen(QPen(QBrush(m_pColors->getLowColor()),
            lineThickness,
            Qt::SolidLine,
            Qt::FlatCap));
    ...
    painter->setPen(QPen(QBrush(m_pColors->getMidColor()),
            lineThickness,
            Qt::SolidLine,
            Qt::FlatCap));
    ...
    painter->setPen(QPen(QBrush(m_pColors->getHighColor()),
            lineThickness,
            Qt::SolidLine,
            Qt::FlatCap));

...
void QtWaveformRendererSimpleSignal::draw(QPainter* painter, QPaintEvent* /*event*/) {
    ...
    for (int channel = 0; channel < channelSeparation; ++channel) {
        ...
        for (int x = startPixel;
            ...
            //     waveform->getAudioVisualRatio(); qDebug() <<
            //     "visualSampleRate" << waveform->getVisualSampleRate();
            ...
            //     "xSampleWidth" << xSampleWidth; qDebug() <<
            //     "xVisualSampleIndex" << xVisualSampleIndex; qDebug() <<
            //     "maxSamplingRange" << maxSamplingRange;; qDebug() <<
            //     "Sampling pixel " << x << "over [" << visualIndexStart <<
            //     visualIndexStop << "]";
            // }

...
// See also:
// https://mf4.xiph.org/jenkins/view/opus/job/opusfile-unix/ws/doc/html/group__stream__info.html
...
SoundSource::OpenResult SoundSourceOpus::tryOpen(
    ...
    const auto prefetchChannelCount =
            std::min(getSignalInfo().getChannelCount(), audio::ChannelCount(2));

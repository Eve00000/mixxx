...
class Ui_DlgAutoDJ {
  public:
    ...
    void retranslateUi(QWidget* DlgAutoDJ) {
        DlgAutoDJ->setWindowTitle(QCoreApplication::translate("DlgAutoDJ", "Auto DJ", nullptr));
        labelTransitionAppendix->setText(QCoreApplication::translate("DlgAutoDJ", "sec.", nullptr));

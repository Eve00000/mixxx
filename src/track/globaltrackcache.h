...
//     virtual ~GlobalTrackCacheLocker();
//
//     GlobalTrackCacheLocker& operator=(const GlobalTrackCacheLocker&) =
//     delete; GlobalTrackCacheLocker& operator=(GlobalTrackCacheLocker&&) =
//     delete;
//
//     void unlockCache();
//
...
//     void initTrackIdAndUnlockCache(TrackId trackId);
//
//     GlobalTrackCacheResolver& operator=(const GlobalTrackCacheResolver&) =
//     delete; GlobalTrackCacheResolver& operator=(GlobalTrackCacheResolver&&) =
//     delete;
//
// private:
//     friend class GlobalTrackCache;
...
//     static void createInstance(
//             GlobalTrackCacheSaver* pSaver,
//             // A custom deleter is only needed for tests without an event
//             loop! deleteTrackFn_t deleteTrackFn = nullptr);
//     // NOTE(uklotzde, 2018-02-20): We decided not to destroy the singular
//     // instance during shutdown, because we are not able to guarantee that
//     // all track references have been released before. Instead the singular
//     // instance is only deactivated. The following function has only been
...
//
//     // Deleter callbacks for the smart-pointer
//     static void evictAndSaveCachedTrack(GlobalTrackCacheEntryPointer
//     cacheEntryPtr);
//
//   private slots:
//     void slotEvictAndSave(GlobalTrackCacheEntryPointer cacheEntryPtr);
...
//
//     // This caches the unsaved Tracks by ID
//     typedef std::unordered_map<TrackId, GlobalTrackCacheEntryPointer,
//     TrackId::hash_fun_t> TracksById; TracksById m_tracksById;
//
//     // This caches the unsaved Tracks by location
//     typedef std::map<QString, GlobalTrackCacheEntryPointer>
//     TracksByCanonicalLocation; TracksByCanonicalLocation

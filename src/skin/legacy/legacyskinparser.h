...
//     static mixxx::skin::SkinManifest getSkinManifest(const QDomElement&
//     skinDocument); static void clearSharedGroupStrings();
//
...
//     QWidget* parseBackground(const QDomElement& node, QWidget* pOuterWidget,
...
//     bool allowConnections = true); void setupPosition(const QDomNode& node,
//     QWidget* pWidget); void setupSize(const QDomNode& node, QWidget*
//     pWidget); void setupBaseWidget(const QDomNode& node, WBaseWidget*
//     pBaseWidget); void setupWidget(const QDomNode& node, QWidget* pWidget,
//     bool setupPosition = true); void setupConnections(const QDomNode& node,
//     WBaseWidget* pWidget);
//
//     QString localizeShortcutKeys(const QString& shortcut);
//
//     /// Helper to create a ConfigKey from a ControlPotmeter base key
//     inline const ConfigKey subKey(const ConfigKey& cfgKey, const QString&
//     subctrl) {

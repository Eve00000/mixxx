...
--Rekordbox-- DELETE FROM rekordbox_playlist_tracks WHERE playlist_id NOT IN(
        SELECT id FROM rekordbox_playlists);
--DELETE FROM rekordbox_playlist_tracks WHERE track_id NOT IN (SELECT id FROM rekordbox_library);

--Rhythmbox-- DELETE FROM rhythmbox_playlist_tracks WHERE playlist_id NOT IN(
        SELECT id FROM rhythmbox_playlists);

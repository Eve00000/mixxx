...
if [ -n "${BUILDENV_ARM64}" ];
then VCPKG_TARGET_TRIPLET = "arm64-osx-min1100-release" BUILDENV_BRANCH =
        "2.5-rel" BUILDENV_NAME =
                "mixxx-deps-2.5-arm64-osx-min1100-release-"
                "40c29ff" BUILDENV_SHA256 =
                        "b76685e77f681baf8fdc5037297b0f16d323a405d09ce276d88443"
                        "04530278e1" else if[-n "${BUILDENV_RELEASE}"]; then
